...
public:
    ...
    Fast_Fixed<N, K> constexpr operator*(Other a) {
        ...
        if (N > Other::n) {
            if (second.v() >> first.k != 0) {
                return Fast_Fixed<N, K>::from_raw((int64_t) first.v() * (second.v() >> first.k));
            }
            return Fast_Fixed<N, K>::from_raw(((int64_t) first.v() * second.v()) >> first.k);
        }
        if (second.v() >> first.k != 0) {
    ...
    Fast_Fixed<N, K> constexpr operator/(Other a) {
        ...
        if (N > Other::n) {
            if (second.v() >> K == 0) {
                return Fast_Fixed<N, K>::from_raw(((int64_t) first.v() << first.k) / second.v());
            } else {
                return Fast_Fixed<N, K>::from_raw((int64_t) first.v() / (second.v() >> first.k));
            }
        } else {
...
public:
    ...
    constexpr Fixed<N, K> operator*(Other a) {
        ...
        if (N > Other::n) {
            if (second.v() >> first.k != 0) {
                return Fixed<N, K>::from_raw((int64_t) first.v() * (second.v() >> first.k));
            }
            return Fixed<N, K>::from_raw(((int64_t) first.v() * second.v()) >> first.k);
        }
        if (second.v() >> first.k != 0) {
    ...
    constexpr Fixed<N, K> operator/(Other a) {
        ...
        if (N > Other::n) {
            if (second.v() >> K == 0) {
                return Fixed<N, K>::from_raw(((int64_t) first.v() << first.k) / second.v());
            } else {
                return Fixed<N, K>::from_raw((int64_t) first.v() / (second.v() >> first.k));
            }
        } else {
